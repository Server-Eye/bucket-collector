...
//var debugError = require('../../data/bucket-single-error');
//var debugNote = require('../../data/bucket-single-note');
...
function getNew(bId) {
    ...
    //deferred.resolve(Math.round(Math.random()) ? JSON.parse(JSON.stringify(debugNote)) : JSON.parse(JSON.stringify(debugError)));
